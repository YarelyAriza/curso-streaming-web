...
let idFrame, listadoCanciones = ['Monotonía', 'La Bicicleta',
                                  'Me Enamoré', 'Te Felicito'];
let icono = [], uris = {musica: 'res/', caratula: 'img/'}, reproduciendo = 0;
...
function cargarCancion(sentido){
  ...
  reproductor.caratula.classList.add('oculto');
   debugger;
 let v = uris.musica + listadoCanciones[reproduciendo] + '.mp4'; 
  ...
  cancion.URI = uris.musica + listadoCanciones[reproduciendo] + '.mp4';
